...
void dphan8_dmari21() {
 printf("Manh Phan, Dona Maria\n");
 printf("What we learn from the Git: git is a version control that saves changes you make to the program.\n");
 printf("Github is a popular website storing the remote repository.\n");
 printf("A git has three areas: working directory, staging area, local repository");
 }
